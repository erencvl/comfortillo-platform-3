...
export const HEROICA_LEVELS: HeroicaLevel[] = [
  ...
  },
  {
    ...
    color: "text-transparent bg-gradient-to-r from-yellow-400 via-red-500 to-pink-500 bg-clip-text",
    bgColor: "bg-gradient-to-r from-yellow-100 via-red-100 to-pink-100",
    borderColor: "border-gradient-to-r from-yellow-400 via-red-500 to-pink-500",
